...
monaco.editor.defineTheme("oceanic-next", getOceaniNextTheme());
...
app.addEventListener("keydown", handleKeys);

function handleKeys(e: KeyboardEvent) {
  const isAlt = navigator.platform.match("Mac") ? e.metaKey : e.ctrlKey;
...
function getOceaniNextTheme(): monaco.editor.IStandaloneThemeData {
  return {
    base: "vs-dark",
    inherit: true,
    rules: [
